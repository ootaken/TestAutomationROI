...
まず、ROIの試算式の構成要素について、The Return on Investment (ROI) of Test Automation と Cost Benefits Analysis of Test Automation の解説例を見ていきます。

### The Return on Invetsment (ROI) of Test Automationで解説している構成要素

The Return on Investment (ROI) of Test Automation ( http://www.arcondis.com/assets/files/pdf/publikationen/ROI%20of%20Test%20Automation.pdf ) ではROIの構成要素として下記を挙げています。
...
* メリット
 ...
 - テスターの単価が明確でなくても、適用出来る
* デメリット
 - 金額とテスターの単価の問題以外は Simple ROI Method と同様の問題を抱える
...
次回では Cost Benefits Analysis of Test Automation の下記の式の要素の詳細を解説するとともに、この式を使ってスモークテストとGIテストの自動化のROIを実際に求めていきます。
